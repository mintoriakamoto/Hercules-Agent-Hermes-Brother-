# nix/web.nix — Hercules Web Dashboard (Vite/React) frontend build
{ pkgs, herculesNpmLib, ... }:
let
  npm = herculesNpmLib.mkNpmPassthru { folder = "web"; attr = "web"; pname = "hercules-web"; };
...
pkgs.buildNpmPackage (npm // {
  ...
  buildPhase = ''
    ...
    # outDir in vite.config.ts points to ../hercules_cli/web_dist for the
