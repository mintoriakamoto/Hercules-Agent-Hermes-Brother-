class HerculesAgent < Formula
  ...
  homepage "https://hercules-agent.nousresearch.com"
  # Stable source should point at the semver-named sdist asset attached by
  # scripts/release.py, not the CalVer tag tarball.
  url "https://github.com/NousResearch/hercules-agent/releases/download/v2026.3.30/hercules_agent-0.6.0.tar.gz"
