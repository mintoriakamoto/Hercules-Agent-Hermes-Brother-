# Streaming LLM Response Support for Hercules Agent
...
```
HERCULES_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("HERCULES_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `hercules_cli/config.py` | 1 | +streaming config defaults |
...
HERCULES_STREAMING_ENABLED=true
```
