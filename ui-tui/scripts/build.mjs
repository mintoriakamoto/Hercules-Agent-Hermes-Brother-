...
await build({
  ...
  // Skip the prebuilt @hercules/ink bundle and inline the source instead:
  ...
  alias: { '@hercules/ink': resolve(root, 'packages/hercules-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The hercules_cli launcher
