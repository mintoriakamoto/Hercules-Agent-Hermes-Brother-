 ...
 *
 * Symptom: in `hercules --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@hercules/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using hercules --tui and as i type multiline my caret at the end will often ' +
