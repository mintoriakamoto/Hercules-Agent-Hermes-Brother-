import { Box, type ScrollBoxHandle, stringWidth, Text } from '@hercules/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (HERCULES_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (HERCULES_DEV_CREDITS), lowest priority,
