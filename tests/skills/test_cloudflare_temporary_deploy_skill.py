...
class TestRealWorldOutput:
    ...
    REAL = (
        ...
        "Uploaded hercules-temp-hello (0.74 sec)\n"
        "Deployed hercules-temp-hello triggers (0.42 sec)\n"
        "  https://hercules-temp-hello.serene-temple.workers.dev\n"
    )
    ...
    def test_all_fields_from_real_output(self):
        r = pdo.parse(self.REAL)
        assert r["live_url"] == "https://hercules-temp-hello.serene-temple.workers.dev"
