...
The unit tests in tests/hercules_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned hercules-writable by the
...
from hercules_cli.service_manager import S6ServiceManager
