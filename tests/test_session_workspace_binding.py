"""Session <-> workspace grouping key (hercules_state.workspace_key).

The key is what `hercules sessions list --workspace` groups/filters on. It is a
...
from hercules_state import workspace_key
