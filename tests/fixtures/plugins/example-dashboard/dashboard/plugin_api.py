...
part of the bundled-plugins set; a stock hercules-agent install does not see
an "Example" tab in its sidebar. The ``_install_example_plugin`` pytest
fixture in ``tests/hercules_cli/test_web_server.py`` copies this directory
into ``$HERCULES_HOME/plugins/example-dashboard/`` and forces the dashboard
