...
def worker_loop(worker_id: int, hercules_home: str, result_file: str) -> None:
...
def reclaimer_loop(hercules_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="hercules_mixed_stress_")
    print(f"HERCULES_HOME = {home}")
