"""Tests for CodexEventProjector — codex item/* events → Hercules messages list.
...
class TestRoleAlternationInvariant:
    ...
    one item — that breaks Hercules' message alternation invariant."""
