...
Reports live under ``~/.hercules/logs/curator/{YYYYMMDD-HHMMSS}/`` alongside
...
def curator_env(tmp_path, monkeypatch):
    """Isolated HERCULES_HOME with a skills/ dir + reset curator module state."""
...
def curator_env_with_cron(curator_env, monkeypatch):
    ...
    monkeypatch.setattr(jobs_mod, "HERCULES_DIR", home)
