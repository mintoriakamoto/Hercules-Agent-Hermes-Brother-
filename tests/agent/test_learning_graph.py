...
def test_hercules_meta_tolerates_non_dict():
    assert learning_graph._hercules_meta({"metadata": "junk"}) == {}
    assert learning_graph._hercules_meta({"metadata": {"hercules": "junk"}}) == {}
    assert learning_graph._hercules_meta({"metadata": {"hercules": {"category": "x"}}}) == {"category": "x"}
