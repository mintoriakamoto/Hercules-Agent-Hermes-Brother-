...
def test_pending_verify_response_is_preserved_for_cron_delivery(monkeypatch):
    ...
    monkeypatch.setattr("hercules_cli.plugins.invoke_hook", lambda *_a, **_kw: [])
    agent = _LimitAgent()
...
def test_pending_response_records_kanban_timeout(monkeypatch):
    ...
    monkeypatch.setattr("hercules_cli.kanban_db.connect", lambda: conn)
    monkeypatch.setattr("hercules_cli.kanban_db._record_task_failure", record)
    agent = _LimitAgent()
