...
thinking phase.  Hercules's default cloud-stream stale detector
(``HERCULES_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``HERCULES_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
