...
class TestMem0UserIdScoping:
    ...
    def test_no_user_id_no_config_uses_hercules_user(self):
        """Without user_id or config override, should default to 'hercules-user'."""
        from plugins.memory.mem0 import Mem0MemoryProvider
        ...
        assert provider._user_id == "hercules-user"
...
class TestAIAgentUserIdPropagation:
    ...
    def test_user_id_stored_on_agent(self):
        ...
        with patch.dict(os.environ, {"HERCULES_HOME": "/tmp/test_hercules"}):
