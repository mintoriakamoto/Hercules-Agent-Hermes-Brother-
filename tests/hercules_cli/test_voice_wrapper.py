"""Tests for ``hercules_cli.voice`` — the TUI gateway's voice wrapper.
...
class TestNormalizeVoiceRecordKeyForPromptToolkit:
    ...
    def test_ctrl_and_alt_map_to_prompt_toolkit_form(self):
        from hercules_cli.voice import normalize_voice_record_key_for_prompt_toolkit
    ...
    # parser rejects alt+c/d/l because hercules-ink reports Alt as
...
class TestVoiceRecordKeyFromConfig:
    ...
    def test_dict_voice_with_string_record_key(self):
        from hercules_cli.voice import voice_record_key_from_config
...
class TestStopWithoutStart:
    def test_returns_none_when_no_recording_active(self, monkeypatch):
        ...
        import hercules_cli.voice as voice
