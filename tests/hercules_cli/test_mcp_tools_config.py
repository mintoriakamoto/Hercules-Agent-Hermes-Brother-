"""Tests for MCP tools interactive configuration in hercules_cli.tools_config."""

from unittest.mock import patch

from hercules_cli.tools_config import _configure_mcp_tools_interactive

# Patch targets: imports happen inside the function body, so patch at source
_PROBE = "tools.mcp_tool.probe_mcp_server_tools"
_CHECKLIST = "hercules_cli.curses_ui.curses_checklist"
_SAVE = "hercules_cli.tools_config.save_config"
...
def test_disabling_tool_writes_include_list(capsys):
    ...
    catalog flow, `hercules mcp configure`, and this UI all write the same
