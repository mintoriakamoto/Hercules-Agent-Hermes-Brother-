...
class TestFallbackChain:
    ...
    PRIMARY = "https://mintoriakamoto.github.io/Hercules-Agent-Hermes-Brother-/docs/api/model-catalog.json"
    FALLBACK = (
        "https://raw.githubusercontent.com/mintoriakamoto/Hercules-Agent-Hermes-Brother-"
