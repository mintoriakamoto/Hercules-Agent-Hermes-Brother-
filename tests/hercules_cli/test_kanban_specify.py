"""Tests for the specifier module + `hercules kanban specify` CLI surface.
...
from hercules_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `hercules kanban …` argparse surface directly."""
