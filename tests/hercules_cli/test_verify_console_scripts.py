...
class TestVerifyConsoleScriptsInstalled:
    ...
    def test_triggers_reinstall_when_hercules_exe_missing(
    ...
    def test_load_console_script_names_reads_pyproject(self, temp_pyproject):
        from hercules_cli.main import _load_console_script_names

        names = _load_console_script_names()
        assert names == ["hercules", "hercules-agent", "hercules-acp"]
