...
The main() function in hercules_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `hercules -c model`
...
def _build_parser():
    """Build a minimal replica of the hercules top-level parser."""
