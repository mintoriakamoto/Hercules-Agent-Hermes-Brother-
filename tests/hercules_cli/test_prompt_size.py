"""Tests for the ``hercules prompt-size`` diagnostic (issue #34667)."""
...
from hercules_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(hercules_home, memory_text="", user_text=""):
    mem_dir = hercules_home / "memories"
...
def _seed_skill(hercules_home, name, description):
    skill_dir = hercules_home / "skills" / "demo" / name
