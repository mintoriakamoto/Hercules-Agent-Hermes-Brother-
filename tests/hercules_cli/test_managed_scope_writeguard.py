...
def test_config_set_managed_key_does_not_write(homes):
    from hercules_cli.config import set_config_value, read_raw_config
...
def test_save_env_value_managed_key_rejected(env_homes, capsys):
    from hercules_cli.config import save_env_value, get_env_path
...
def test_save_env_value_unmanaged_key_still_works(env_homes):
    from hercules_cli.config import save_env_value, get_env_value
...
def test_save_config_strips_managed_leaves(homes, capsys):
    from hercules_cli.config import save_config, read_raw_config
