"""Tests for the interactive session browser (`hercules sessions browse`).
...
from hercules_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """hercules sessions browse should be parseable."""
