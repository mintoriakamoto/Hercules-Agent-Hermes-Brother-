...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from hercules_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in HERCULES_OVERLAYS
        overlay = HERCULES_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify hercules doctor recognizes Xiaomi env vars."""
