...
the *mutation* side: `hercules plugins enable/disable` must resolve a bare name
...
class TestResolvePluginKey:
    @patch("hercules_cli.plugins.get_bundled_plugins_dir")
    ...
    def test_full_key_resolves_to_itself(self, mock_user, mock_bundled, nested_plugin_env):
        from hercules_cli.plugins_cmd import _resolve_plugin_key
...
class TestEnableDisableNested:
    @patch("hercules_cli.plugins.get_bundled_plugins_dir")
    @patch("hercules_cli.plugins_cmd._plugins_dir")
    @patch("hercules_cli.plugins_cmd._save_disabled_set")
    @patch("hercules_cli.plugins_cmd._save_enabled_set")
    @patch("hercules_cli.plugins_cmd._get_disabled_set", return_value=set())
    @patch("hercules_cli.plugins_cmd._get_enabled_set", return_value=set())
    def test_enable_bare_name_writes_key(
        ...
        from hercules_cli.plugins_cmd import cmd_enable
        mock_user.return_value = nested_plugin_env
        mock_bundled.return_value = nested_plugin_env / "nonexistent"
    ...
    def test_enable_clears_manifest_name_alias_from_disabled(
        ...
        ``hercules plugins disable web-firecrawl`` gets ``web-firecrawl`` in
        ...
        with patch(
            "hercules_cli.plugins_cmd._get_disabled_set",
    ...
    def test_disable_bare_name_writes_key_and_clears_alias(
        ...
        from hercules_cli.plugins_cmd import cmd_disable
        mock_user.return_value = nested_plugin_env
        mock_bundled.return_value = nested_plugin_env / "nonexistent"
...
class TestEnableToolOverrideConsent:
    ...
    @patch("hercules_cli.plugins.get_bundled_plugins_dir")
    @patch("hercules_cli.plugins_cmd._plugins_dir")
    @patch("hercules_cli.plugins_cmd._set_plugin_entry_flag")
    @patch("hercules_cli.plugins_cmd._save_disabled_set")
    @patch("hercules_cli.plugins_cmd._save_enabled_set")
    @patch("hercules_cli.plugins_cmd._get_disabled_set", return_value=set())
    @patch("hercules_cli.plugins_cmd._get_enabled_set", return_value=set())
...
class TestCompositeMenuWritesCanonicalKey:
    """#40190 follow-up: the interactive `hercules plugins` menu must persist
    ...
    def test_fallback_unchecked_plugin_disables_by_key_not_name(
        ...
        from hercules_cli.plugins_cmd import _run_composite_fallback
