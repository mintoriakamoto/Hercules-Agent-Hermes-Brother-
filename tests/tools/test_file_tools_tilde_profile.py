...
``hercules_constants.get_subprocess_home()`` — the same policy the terminal tool
uses for subprocess environments.

See: https://github.com/NousResearch/hercules-agent/issues/48552
"""
...
class TestExpandTilde:
    ...
    def test_falls_back_when_no_profile_home(self):
        ...
        with patch("hercules_constants.get_subprocess_home", return_value=None):
