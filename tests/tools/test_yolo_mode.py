"""Tests for --yolo (HERCULES_YOLO_MODE) approval bypass."""
...
class TestYoloMode:
    """When HERCULES_YOLO_MODE is set, all dangerous commands are auto-approved."""
    ...
    def test_dangerous_command_blocked_normally(self, monkeypatch):
        ...
        monkeypatch.setenv("HERCULES_SESSION_KEY", "test-session")
    ...
    def test_dangerous_command_approved_in_yolo_mode(self, monkeypatch):
        """With HERCULES_YOLO_MODE, dangerous commands are auto-approved."""
