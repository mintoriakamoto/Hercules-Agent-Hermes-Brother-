...
Browser automation is optional. The installer should not leave Hercules
...
def test_install_script_does_not_autodetect_system_browser_on_path() -> None:
    ...
    assert "Skipping Playwright browser download; Hercules will use the system browser." not in text
