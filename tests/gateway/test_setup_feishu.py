"""Tests for _setup_feishu() in hercules_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("hercules_cli.config.save_env_value", side_effect=mock_save), \
         patch("hercules_cli.config.get_env_value", side_effect=mock_get), \
         patch("hercules_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("hercules_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("hercules_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("hercules_cli.cli_output.print_header"), \
         patch("hercules_cli.cli_output.print_info"), \
         patch("hercules_cli.cli_output.print_success"), \
         patch("hercules_cli.cli_output.print_warning"), \
         patch("hercules_cli.cli_output.print_error"), \
