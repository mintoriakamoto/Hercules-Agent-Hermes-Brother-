...
def _make_adapter(monkeypatch, *, interval=0.01, threshold=1) -> DiscordAdapter:
    monkeypatch.setenv("HERCULES_DISCORD_LIVENESS_INTERVAL_SECONDS", str(interval))
    monkeypatch.setenv("HERCULES_DISCORD_LIVENESS_FAILURE_THRESHOLD", str(threshold))
