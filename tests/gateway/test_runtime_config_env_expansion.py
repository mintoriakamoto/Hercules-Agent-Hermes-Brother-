...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("HERCULES_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("HERCULES_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("HERCULES_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
