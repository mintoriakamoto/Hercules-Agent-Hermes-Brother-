...
async def test_start_gateway_verbosity_imports_redacting_formatter(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("hercules_logging.setup_logging", lambda hercules_home, mode: tmp_path)
    monkeypatch.setattr("hercules_logging._add_rotating_handler", lambda *args, **kwargs: None)
