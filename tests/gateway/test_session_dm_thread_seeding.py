...
def store(tmp_path, monkeypatch):
    ...
    ~/.hercules/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at hercules_state import time, before pytest's HERCULES_HOME monkeypatch
    fires — the autouse fixture's HERCULES_HOME override doesn't help here.)
    """
