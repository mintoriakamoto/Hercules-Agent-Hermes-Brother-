...
class TestTopLevelCwdAlias:
    ...
    def test_top_level_cwd_sets_terminal_cwd(self):
        cfg = {"cwd": "/home/hercules/projects"}
        result = _simulate_config_bridge(cfg)
        assert result["TERMINAL_CWD"] == "/home/hercules/projects"
    ...
    def test_top_level_cwd_and_backend(self):
        cfg = {"backend": "local", "cwd": "/home/hercules/projects"}
        result = _simulate_config_bridge(cfg)
        assert result["TERMINAL_CWD"] == "/home/hercules/projects"
    ...
    def test_nested_terminal_takes_precedence_over_top_level(self):
        ...
        cfg = {
            "cwd": "/should/not/use",
            "terminal": {"cwd": "/home/hercules/real"},
        }
        result = _simulate_config_bridge(cfg)
        assert result["TERMINAL_CWD"] == "/home/hercules/real"
    ...
    def test_no_cwd_falls_back_to_messaging_cwd(self):
        cfg = {}
        result = _simulate_config_bridge(cfg, {"MESSAGING_CWD": "/home/hercules/projects"})
        assert result["TERMINAL_CWD"] == "/home/hercules/projects"
    ...
    def test_dot_cwd_triggers_messaging_fallback(self):
        ...
        cfg = {"cwd": "."}
        result = _simulate_config_bridge(cfg, {"MESSAGING_CWD": "/home/hercules"})
        ...
        assert result["TERMINAL_CWD"] == "/home/hercules"
