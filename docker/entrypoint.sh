...
# by /etc/cont-init.d/01-hercules-setup (installed by the Dockerfile). This
...
# on the pre-s6 contract "entrypoint.sh sets up state then execs hercules"
...
echo "[hercules] WARNING: docker/entrypoint.sh is a deprecated shim under " \
