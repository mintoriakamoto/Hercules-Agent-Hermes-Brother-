...
cd apps/desktop
XCURSOR_SIZE=24 HERCULES_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/hercules-typing
# → /tmp/hercules-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/hercules-typing.before.heapsnapshot
# → /tmp/hercules-typing.after.heapsnapshot
```
