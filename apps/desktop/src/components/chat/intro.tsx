...
const FALLBACK_COPY: IntroCopy[] = [
  ...
  {
    headline: 'What should Hercules look at?',
...
function fallbackCopyForPersonality(personalityKey: string): IntroCopy[] {
  ...
  return [
    ...
    {
      headline: `What does ${label} Hercules need to see?`,
    ...
    {
      headline: `What should ${label} Hercules tackle?`,
