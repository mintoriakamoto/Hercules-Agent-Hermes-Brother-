...
export const en: Translations = {
  ...
  boot: {
    ready: 'Hercules Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Hercules settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHerculesDesktop: 'Starting Hercules Desktop…'
    },
    errors: {
      backgroundExited: 'Hercules background process exited.',
      backgroundExitedDuringStartup: 'Hercules background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Hercules backend is older than this desktop build and may not work correctly. Update to align them.',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Hercules Desktop.',
    ...
    native: {
      ...
      inputBody: 'Hercules is waiting for your response.',
      turnDoneTitle: 'Hercules finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Hercules defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Hercules is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Hercules asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Hercules was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Hercules follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Hercules is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Hercules, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Hercules checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Hercules configuration...',
    ...
    gateway: {
      ...
      intro:
        'Hercules Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Hercules backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset HERCULES_DESKTOP_REMOTE_URL and HERCULES_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      ...
      cloudSignIn: 'Sign in to Hercules Cloud',
      cloudSignedIn: 'Signed in to Hercules Cloud',
      cloudNeedsSignIn: 'Sign in to Hercules Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Hercules Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Hercules Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Hercules Cloud',
      cloudSignedOutMessage: 'Cleared the Hercules Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /hercules.',
      ...
      restartingMessage: 'Hercules Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Hercules ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Hercules runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via hercules curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Hercules builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Hercules to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Hercules to generate pets.',
      backgroundHint: 'You can close this — Hercules will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Hercules desktop' },
    ...
    herculesActiveSessions: (version, count) => `Hercules ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@hercules:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Hercules environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Hercules will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Hercules backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Hercules. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Hercules...',
    placeholderReconnecting: 'Reconnecting to Hercules…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give Hercules a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'Hercules will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Hercules to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Hercules…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Hercules…',
    ...
    unsupportedMessage: 'This version of Hercules can’t update itself from inside the app.',
    ...
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Hercules desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Hercules updater takes over in its own window and reopens Hercules automatically when it’s done. Please don’t reopen Hercules yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Hercules reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Hercules reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Hercules needs a one-time install',
    ...
    settingUpTitle: 'Setting up Hercules Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Hercules CLI or desktop instance is running. Stop any running Hercules instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Hercules Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Hercules is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Hercules…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Hercules',
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Hercules connects automatically',
    ...
    authorizeThere: 'Authorize Hercules there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Hercules there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Hercules Desktop v${version}`,
      ...
      gatewayTitle: 'Hercules inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Hercules will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Hercules is restarting...',
      askRestart: 'Ask Hercules to restart the server',
      lookingRestart: taskId => `Hercules is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Hercules is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Hercules finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Hercules could not restart the server.',
      stillWorking:
        'Hercules is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Hercules is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Hercules gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hercules/config.yaml). Hercules won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Hercules needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Hercules needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Hercules Desktop to use Save Image.',
    restartToSaveImages: 'Restart Hercules Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `hercules gateway` running?'
    }
  },
