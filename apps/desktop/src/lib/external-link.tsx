...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|hercules):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.herculesDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.herculesDesktop?.openExternal?.(href)
  }
}
