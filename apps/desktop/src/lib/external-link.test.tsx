...
const desktopWindow = window as unknown as { herculesDesktop?: Window['herculesDesktop'] }
const initialHerculesDesktop = desktopWindow.herculesDesktop

function installDesktopBridge(partial: Partial<Window['herculesDesktop']> = {}) {
  desktopWindow.herculesDesktop = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['herculesDesktop']
}
...
afterEach(() => {
  ...
  if (initialHerculesDesktop) {
    desktopWindow.herculesDesktop = initialHerculesDesktop
  } else {
    delete desktopWindow.herculesDesktop
  }
})
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['herculesDesktop']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['herculesDesktop']['openExternal'] })
