import type { HerculesReviewFile } from '@/global'
...
export function buildReviewFlatList(files: HerculesReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: HerculesReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
