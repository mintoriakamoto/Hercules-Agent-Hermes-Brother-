...
const TAKEOVER_KEY = 'hercules.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Hercules can't clear via the API — the user
 *  sees exactly what runs instead of Hercules silently deleting their creds. */
