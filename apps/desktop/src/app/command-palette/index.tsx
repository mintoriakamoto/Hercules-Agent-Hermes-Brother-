...
import { getHerculesConfigRecord, listAllProfileSessions } from '@/hercules'
...
// Hercules session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
...
export function CommandPalette() {
  ...
  const configQuery = useQuery({
    ...
    queryFn: getHerculesConfigRecord,
    enabled: open
  })
    ...
    return [
      ...
      ...branchGroup,
      {
        ...
        items: [
          ...
          {
            icon: Download,
            id: 'cc-update-hercules',
            keywords: ['update', 'upgrade', 'hercules', 'version', 'system', 'restart'],
            label: cc.updateHercules,
