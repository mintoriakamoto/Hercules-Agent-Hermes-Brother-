...
import { getHerculesConfigDefaults, getHerculesConfigRecord, saveHerculesConfig } from '@/hercules'
...
export function SettingsView({ onClose, onConfigSaved, onMainModelChanged }: SettingsPageProps) {
  ...
  const exportConfig = async () => {
    try {
      const cfg = await getHerculesConfigRecord()
  ...
  const resetConfig = async () => {
    ...
    try {
      await saveHerculesConfig(await getHerculesConfigDefaults())
      triggerHaptic('success')
      onConfigSaved?.()
    } catch (err) {
