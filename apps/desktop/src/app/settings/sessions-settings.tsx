...
import { deleteSession, listAllProfileSessions, setSessionArchived } from '@/hercules'
...
// / Program Files), which buried any files Hercules wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.herculesDesktop` is
    ...
    const settings = window.herculesDesktop?.settings
