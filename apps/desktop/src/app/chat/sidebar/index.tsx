...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/hercules'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('hercules:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('hercules:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Hercules to
