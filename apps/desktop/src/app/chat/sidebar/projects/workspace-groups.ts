...
import type { ProjectInfo, SessionInfo } from '@/hercules'
 ...
 * repo shows its branches/worktrees even when they have no Hercules sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: HerculesGitWorktree[]
): SidebarSessionGroup[] {
