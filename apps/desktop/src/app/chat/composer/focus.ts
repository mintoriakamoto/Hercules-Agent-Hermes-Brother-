...
const FOCUS_EVENT = 'hercules:composer-focus'
const INSERT_EVENT = 'hercules:composer-insert'
const INSERT_REFS_EVENT = 'hercules:composer-insert-refs'
const SUBMIT_EVENT = 'hercules:composer-submit'
const VOICE_TOGGLE_EVENT = 'hercules:composer-voice-toggle'
