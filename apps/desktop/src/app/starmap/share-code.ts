...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/hercules'
...
const VERSION = 3
const PREFIX = 'HML' // "Hercules Memory Loadout" — namespaces our codes like WoW's leading bytes.
