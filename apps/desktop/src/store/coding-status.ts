...
import type { HerculesGitWorktree, HerculesRepoStatus } from '@/global'
...
export const $repoStatus = atom<HerculesRepoStatus | null>(null)
...
export const $repoWorktrees = atom<HerculesGitWorktree[]>([])
