...
export interface PetInfo {
  ...
  // the Hercules "run" activity state uses the in-place running row).
 ...
 * HERCULES_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'hercules.desktop.pet-roam.v1'
