...
// even though a fresh shell — and the Hercules CLI — sees it immediately. The
// desktop's HERCULES_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\hercules. Reading
...
//       HERCULES_HOME    REG_SZ    F:\Hercules\data
//
