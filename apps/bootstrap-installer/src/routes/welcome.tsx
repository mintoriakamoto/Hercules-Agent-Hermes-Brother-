 ...
 *   - HERCULES AGENT wordmark rendered in Collapse Bold, uppercase, tracked
 ...
 * 99% of users; the rest will use the CLI installer with a -HerculesHome
 * flag. Showing %LOCALAPPDATA% to grandma is developer-brain.
 */
export default function Welcome() {
  return (
    <div className="hercules-fade-in flex h-full flex-col items-center justify-center gap-10 px-12 py-10">
      ...
      <div className="w-full max-w-2xl min-w-0 text-center">
        ...
        >
          <span>
            <span>HERCULES AGENT</span>
          </span>
          <span aria-hidden="true">HERCULES AGENT</span>
        </p>
