...
o el [reporte privado de vulnerabilidades de GitHub](https://github.com/mintoriakamoto/Hercules-Agent-Hermes-Brother-/security/advisories/new). No abras issues públicos para
