#!/usr/bin/env python3
"""Build the Hercules Skills Index — a centralized JSON catalog of all skills.
...
`hercules skills search/install` can use it without hitting the GitHub API.
...
# Ensure HERCULES_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Hercules Skills Index...", flush=True)
