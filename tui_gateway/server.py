...
def _get_usage(agent) -> dict:
    ...
    # HERCULES_DEV_CREDITS so the payload stays clean when the flag is off.
    if is_truthy_value(os.environ.get("HERCULES_DEV_CREDITS")):
        try:
...
def _(rid, params: dict) -> dict:
    ...
    """
    from hercules_cli.nous_billing import BillingError, post_charge
...
def _(rid, params: dict) -> dict:
    ...
    """
    from hercules_cli.nous_billing import BillingError, get_charge_status
...
def _(rid, params: dict) -> dict:
    ...
    """
    from hercules_cli.nous_billing import BillingError, patch_auto_top_up
...
def _(rid, params: dict) -> dict:
    ...
    try:
        from hercules_cli.auth import step_up_nous_billing_scope
