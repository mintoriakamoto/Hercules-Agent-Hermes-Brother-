...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$HERCULES_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_hercules_dir("platforms/whatsapp/session", "whatsapp/session")
