"""Client for uploading ``hercules debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``hercules debug share``.
...
NAS_BASE = os.environ.get(
    "HERCULES_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "hercules-agent/debug-share"
