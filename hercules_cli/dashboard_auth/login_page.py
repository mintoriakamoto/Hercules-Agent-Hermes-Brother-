...
``tests/hercules_cli/test_dashboard_auth_401_reauth.py``.
"""
...
<title>Sign in — Hercules Agent</title>
<style>
...
<main>
  ...
  <div class="card">
    <h1>Sign in</h1>
    <p class="subtitle">Choose a sign-in method to continue to the Hercules Agent dashboard.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Sign-in unavailable — Hercules Agent</title>
<style>
  @font-face {
    font-family: 'Collapse';
    font-style: normal;
