"""
Hercules CLI - Unified command-line interface for Hercules Agent.

Provides subcommands for:
- hercules chat          - Interactive chat (same as ./hercules)
- hercules gateway       - Run gateway in foreground
- hercules gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `hercules setup` on a fresh Pi.
    ...
    hercules_cli/stdio.py::configure_windows_stdio() runs later from the entry
