"""``hercules tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'hercules tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # hercules tools list [--platform cli]
    ...
    # hercules tools disable <name...> [--platform cli]
    ...
    # hercules tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `hercules tools` runs after you pick a provider that\n"
