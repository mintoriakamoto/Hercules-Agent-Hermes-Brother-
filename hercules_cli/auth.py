...
SPOTIFY_DOCS_URL = "https://github.com/mintoriakamoto/Hercules-Agent-Hermes-Brother-/blob/main/website/docs/user-guide/features/spotify.md"
SPOTIFY_DASHBOARD_URL = "https://developer.spotify.com/dashboard"
SPOTIFY_ACCESS_TOKEN_REFRESH_SKEW_SECONDS = 120

OAUTH_OVER_SSH_DOCS_URL = "https://github.com/mintoriakamoto/Hercules-Agent-Hermes-Brother-/blob/main/website/docs/guides/oauth-over-ssh.md"
