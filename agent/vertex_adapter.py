"""Vertex AI (Google Cloud) adapter for Hercules Agent.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows Hercules to use Gemini models via Google Cloud with
...
# who installed plain `hercules-agent` and only later selected a Gemini model.
try:
