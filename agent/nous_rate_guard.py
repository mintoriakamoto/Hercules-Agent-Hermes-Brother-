...
(3 SDK retries x 3 Hercules retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_hercules_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".hercules")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Hercules, ...) behind one endpoint.  A 429 can mean either:
