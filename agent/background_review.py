...
See the ``hercules-agent-dev`` skill (``references/self-improvement-loop.md``)
...
_SKILL_REVIEW_PROMPT = (
    ...
    "  • Bundled skills (shipped with Hercules, e.g. 'hercules-agent').\n"
    "  • Hub-installed skills (installed via 'hercules skills install').\n"
    "Pinned skills (marked via 'hercules curator pin') CAN be improved — "
...
def build_memory_write_metadata(
    ...
    *,
    ...
    metadata: Dict[str, Any] = {
        ...
        "platform": agent.platform or os.environ.get("HERCULES_SESSION_SOURCE", "cli"),
        "tool_name": "memory",
    }
    if task_id:
...
def _run_review_in_thread(
    ...
    try:
        ...
        with thread_scoped_silence():
            ...
            # scratch (fresh _hercules_now() timestamp, fresh
