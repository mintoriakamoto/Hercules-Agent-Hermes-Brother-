...
existing Hercules-facing JSON contract and falls back to the Python client
...
from _hercules_home import get_hercules_home
...
def _gws_binary() -> str | None:
    override = os.getenv("HERCULES_GWS_BIN")
    if override:
        return override
