...
const STORAGE_KEY = "hercules-dashboard-theme";
...
const FONT_STORAGE_KEY = "hercules-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `hercules_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "hercules-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-hercules-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-hercules-theme-font", "true");
