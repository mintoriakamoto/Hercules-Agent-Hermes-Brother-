...
export interface Translations {
  ...
  status: {
    ...
    stopped: string;
    updateHercules: string;
    updateHerculesConfirmMessage?: string;
    updateHerculesConfirmNow?: string;
    updateHerculesConfirmTitle?: string;
    updatingHercules: string;
  ...
  // ── Achievements plugin (plugins/hercules-achievements) ──
  achievements: {
    hero: {
      kicker: string;
      title: string;
