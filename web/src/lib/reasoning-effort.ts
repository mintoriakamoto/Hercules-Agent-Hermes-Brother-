 ...
 *
 * Values mirror hercules_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Hercules default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Hercules' default when unset). */
