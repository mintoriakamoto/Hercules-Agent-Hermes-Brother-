 ...
 *
 * Plugins call window.__HERCULES_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__HERCULES_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__HERCULES_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__HERCULES_PLUGIN_SDK__ = {
    ...
    // window.__HERCULES_SESSION_TOKEN__ directly.
    authedFetch,
