...
| 版本 | `1.0.0` |
| 作者 | Hercules Agent + Teknium（设计系统来源：VoltAgent/awesome-design-md） |
| 许可证 | MIT |
...
每个模板顶部都包含一个 **Hercules 实现说明** 块，内容包括：
...
<head>
  ...
  <!-- Paste the Google Fonts <link> from the template's Hercules notes -->
