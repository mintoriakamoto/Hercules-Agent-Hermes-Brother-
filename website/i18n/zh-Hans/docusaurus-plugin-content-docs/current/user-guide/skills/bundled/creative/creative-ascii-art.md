...
```bash
python3 -m pyfiglet "HERCULES" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=HERCULES&font=Slant" | boxes -d stone
```
