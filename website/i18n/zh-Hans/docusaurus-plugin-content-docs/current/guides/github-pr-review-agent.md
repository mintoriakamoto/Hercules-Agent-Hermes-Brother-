...
```
Run: gh pr list --repo mintoriakamoto/Hercules-Agent-Hermes-Brother- --state open --limit 3
```
...
Run: gh pr diff 3888 --repo mintoriakamoto/Hercules-Agent-Hermes-Brother-
```
