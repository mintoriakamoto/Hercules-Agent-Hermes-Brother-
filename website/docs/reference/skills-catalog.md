...
| [`hercules-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-hercules-agent) | Configure, extend, or contribute to Hercules Agent. | `autonomous-ai-agents/hercules-agent` |
...
| [`petdex`](/docs/user-guide/skills/bundled/productivity/productivity-petdex) | Install and select animated petdex mascots for Hercules. | `productivity/petdex` |
...
| [`teams-meeting-pipeline`](/docs/user-guide/skills/bundled/productivity/productivity-teams-meeting-pipeline) | Operate the Teams meeting summary pipeline via Hercules CLI — summarize meetings, inspect pipeline status, replay jobs, manage Microsoft Graph subscriptions. | `productivity/teams-meeting-pipeline` |
...
| Skill | Description | Path |
|-------|-------------|------|
| [`hercules-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-hercules-agent-skill-authoring) | Author in-repo SKILL.md: frontmatter, validator, structure. | `software-development/hercules-agent-skill-authoring` |
...
| [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan) | Plan mode: write an actionable markdown plan to .hercules/plans/, no execution. Bite-sized tasks, exact paths, complete code. | `software-development/plan` |
