...
```bash
/cron add "every 6h" "Check the GitHub repository mintoriakamoto/Hercules-Agent-Hermes-Brother- for:
- New issues opened in the last 6 hours
- New PRs opened or merged in the last 6 hours
- Any new releases

Use the terminal to run gh commands:
  gh issue list --repo mintoriakamoto/Hercules-Agent-Hermes-Brother- --state open --json number,title,author,createdAt --limit 10
  gh pr list --repo mintoriakamoto/Hercules-Agent-Hermes-Brother- --state all --json number,title,author,createdAt,mergedAt --limit 10
