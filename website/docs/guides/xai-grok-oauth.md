...
This is **not** a stale-token problem — re-running `hercules model` won't change it. xAI's backend has been seen to restrict OAuth API access to specific SuperGrok tiers despite the in-app subscription being active (issue [#26847](https://github.com/mintoriakamoto/Hercules-Agent-Hermes-Brother-/issues/26847)).
