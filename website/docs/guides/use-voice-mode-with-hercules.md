---
sidebar_position: 8
title: "Use Voice Mode with Hercules"
description: "A practical guide to setting up and using Hercules voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with Hercules
...
:::tip
Use [OpenRouter](/integrations/providers#openrouter) for the LLM, then configure TTS through the [Tool Gateway](/user-guide/features/tool-gateway) — voice mode works end-to-end.
:::
...
- you want Hercules sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in Hercules.
...
## Step 1: make sure normal Hercules works first
...
Hercules supports both local and cloud speech stacks.
...
4. Hercules transcribes and responds
...
- asking Hercules to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full Hercules loop.

## Tuning CLI behavior

### Silence threshold

If Hercules starts/stops too aggressively, tune:
...
Hercules stays a normal chat bot, but can speak replies.
...
- you want Hercules to function like a portable research or ops assistant
...
Hercules joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- Hercules detects speech boundaries
- transcripts are posted in the associated text channel
- Hercules responds in text and audio
...
1. get text Hercules working
2. install `hercules-agent[voice]`
