...
* Implementation: [`agent/plugin_llm.py`](https://github.com/mintoriakamoto/Hercules-Agent-Hermes-Brother-/blob/main/agent/plugin_llm.py)
* Tests: [`tests/agent/test_plugin_llm.py`](https://github.com/mintoriakamoto/Hercules-Agent-Hermes-Brother-/blob/main/tests/agent/test_plugin_llm.py)
