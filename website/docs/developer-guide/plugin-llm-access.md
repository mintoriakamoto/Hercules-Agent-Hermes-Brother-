...
* Implementation: [`agent/plugin_llm.py`](https://github.com/NousResearch/hercules-agent/blob/main/agent/plugin_llm.py)
* Tests: [`tests/agent/test_plugin_llm.py`](https://github.com/NousResearch/hercules-agent/blob/main/tests/agent/test_plugin_llm.py)
