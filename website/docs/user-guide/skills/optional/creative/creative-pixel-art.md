...
| | |
|---|---|
| Source | Optional — install with `hercules skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.hercules/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.hercules/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Hercules installs package this)
