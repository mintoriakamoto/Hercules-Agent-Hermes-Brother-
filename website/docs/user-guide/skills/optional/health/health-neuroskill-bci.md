...
| | |
|---|---|
| Source | Optional — install with `hercules skills install official/health/neuroskill-bci` |
...
Connect Hercules to a running [NeuroSkill](https://neuroskill.com/) instance to read
