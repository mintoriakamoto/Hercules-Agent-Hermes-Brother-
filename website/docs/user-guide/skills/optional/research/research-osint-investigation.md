...
| | |
|---|---|
| Source | Optional — install with `hercules skills install official/research/osint-investigation` |
...
# $HERCULES_OSINT_CACHE/icij/ (default: ~/.cache/hercules-osint/icij/).
...
# Set HERCULES_OSINT_UA=your-app/1.0 (your@email) to identify yourself
