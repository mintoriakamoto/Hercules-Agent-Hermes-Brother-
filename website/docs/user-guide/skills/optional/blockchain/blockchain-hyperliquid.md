...
| | |
|---|---|
| Source | Optional — install with `hercules skills install official/blockchain/hyperliquid` |
...
The script reads `${HERCULES_HOME:-~/.hercules}/.env` for two optional defaults:
...
Helper script: `~/.hercules/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.hercules/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${HERCULES_HOME:-~/.hercules}/.env`.
...
```bash
python3 ~/.hercules/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.hercules/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
