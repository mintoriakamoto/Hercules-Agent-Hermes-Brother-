...
| | |
|---|---|
| Source | Optional — install with `hercules skills install official/blockchain/solana` |
...
Helper script path: ~/.hercules/skills/blockchain/solana/scripts/solana_client.py
