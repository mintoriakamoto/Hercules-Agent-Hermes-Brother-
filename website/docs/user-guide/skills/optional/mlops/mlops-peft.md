...
- **[Advanced Usage](https://github.com/mintoriakamoto/Hercules-Agent-Hermes-Brother-/blob/main/optional-skills/mlops/peft/references/advanced-usage.md)** - DoRA, LoftQ, rank stabilization, custom modules
- **[Troubleshooting](https://github.com/mintoriakamoto/Hercules-Agent-Hermes-Brother-/blob/main/optional-skills/mlops/peft/references/troubleshooting.md)** - Common errors, debugging, optimization
