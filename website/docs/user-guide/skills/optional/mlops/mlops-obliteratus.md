...
| | |
|---|---|
| Source | Optional — install with `hercules skills install official/mlops/obliteratus` |
...
Walkthrough of OBLITERATUS used by a Hercules agent to abliterate Gemma:
