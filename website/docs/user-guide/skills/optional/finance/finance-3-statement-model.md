...
See [references/formulas.md](https://github.com/NousResearch/hercules-agent/blob/main/optional-skills/finance/3-statement-model/references/formulas.md) for all formula details.
