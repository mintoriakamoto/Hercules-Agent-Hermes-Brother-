...
- User wants **Hercules itself to drive a browser** → use Hercules' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
