...
Message-template support (the workaround for outside-window sends) is not yet implemented in Hercules. If you need it, please [open an issue](https://github.com/mintoriakamoto/Hercules-Agent-Hermes-Brother-/issues) — it's planned but waiting on a clear demand signal.
