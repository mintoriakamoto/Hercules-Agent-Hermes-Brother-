...
The historical issue for this is [#19931](https://github.com/mintoriakamoto/Hercules-Agent-Hermes-Brother-/issues/19931) and the closed-not-merged Codex-specific PR [#19924](https://github.com/mintoriakamoto/Hercules-Agent-Hermes-Brother-/pull/19924) — those describe the original architecture proposal but didn't land a runner.
...
- [`KANBAN_GUIDANCE`](https://github.com/mintoriakamoto/Hercules-Agent-Hermes-Brother-/blob/main/agent/prompt_builder.py) — the worker + orchestrator lifecycle injected into every kanban worker's system prompt.
