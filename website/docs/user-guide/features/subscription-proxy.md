...
| Use case | "Use Hercules as a chat backend" | "Use my Portal sub from another app" |
...
This opens your browser for the Nous Portal OAuth flow. Hercules stores
...
interface in `hercules_cli/proxy/adapters/`.
...
If you see `not logged in`, run `hercules portal`. If you see
