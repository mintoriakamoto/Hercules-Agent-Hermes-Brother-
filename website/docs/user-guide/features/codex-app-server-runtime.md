...
If you find a bug, [open an issue](https://github.com/mintoriakamoto/Hercules-Agent-Hermes-Brother-/issues) with the output of `hercules logs --since 5m`. Mention `codex-runtime` in the title so it's easy to triage.
...
For implementation details, see [PR #24182](https://github.com/mintoriakamoto/Hercules-Agent-Hermes-Brother-/pull/24182) and the [Codex app-server protocol README](https://github.com/openai/codex/blob/main/codex-rs/app-server/README.md).
