...
[OpenRouter](/integrations/providers#openrouter) provides 300+ models under one API key. Add `OPENROUTER_API_KEY` to `~/.hercules/.env`, then run `hercules model` to pick a model — the recommended default.
:::
