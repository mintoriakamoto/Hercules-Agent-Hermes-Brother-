...
Data file: $HERCULES_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_HERCULES_HOME = Path(os.environ.get("HERCULES_HOME", Path.home() / ".hercules"))
DATA_DIR = _HERCULES_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
