# Hercules Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.hercules/plugins/hercules-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.hercules/plugins/hercules-achievements/scan_checkpoint.json`.
