# Hercules Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.hercules/plugins/hercules-achievements/state.json` (existing unlock state)
  - `~/.hercules/plugins/hercules-achievements/scan_snapshot.json` (new)
  - `~/.hercules/plugins/hercules-achievements/scan_checkpoint.json` (new)
