...
Config: ~/.hercules/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.hercules/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_hercules_home()`` helper (HERCULES_HOME-aware and
...
RULES_FILE = get_hercules_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_hercules_home() / "feishu_comment_pairing.json"
