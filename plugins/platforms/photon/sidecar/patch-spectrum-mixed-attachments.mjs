...
// `message.content.text` before Hercules can see it. We rewrite the two inbound
...
const MARKER = "Hercules patch: Preserve mixed text + attachment iMessage payloads";
