...
``_check_spotify_available()`` — when the user has not run ``hercules auth
spotify``, the tools remain registered (so they appear in ``hercules
...
The Spotify auth flow (``hercules auth spotify``), CLI plumbing, and docs
